...
import { Leaf, User, Mail, Phone, Lock, ArrowRight, AlertCircle } from 'lucide-react';
  ...
  return (
    <div className="max-w-md mx-auto px-4 py-12 space-y-6">
      ...
      <div className="text-center space-y-2">
        ...
        <h1 className="text-3xl font-extrabold text-emerald-950 font-heading">Create Account</h1>
        <p className="text-xs text-stone-500">Join Mulaiparri for organic microgreen home deliveries</p>
      </div>
      ...
      <div className="bg-white p-8 rounded-3xl border border-stone-200 shadow-xl space-y-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-xs font-semibold">
          ...
          >
            <span>{loading ? 'Creating Account...' : 'Register & Join Mulaiparri'}</span>
